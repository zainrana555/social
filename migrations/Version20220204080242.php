 ...
 */
final class Version20220204080242 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP created_at, DROP updated_at, CHANGE message message LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
